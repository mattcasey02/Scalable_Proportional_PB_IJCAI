"""
Run Exact Equal Shares with add1 completion (approval utilities, non-exhaustive).
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python run_approval_equal_shares_addone_non_exhaustive.py <file_path>")
        sys.exit(1)
    ...
    results_dir = setup_results_dir("exact_equal_shares/approval/addone_non_exhaustive")
