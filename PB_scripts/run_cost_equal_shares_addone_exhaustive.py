"""
Run Exact Equal Shares with add1 completion (cost utilities, exhaustive).
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python run_cost_equal_shares_addone_exhaustive.py <file_path>")
        sys.exit(1)
    ...
    results_dir = setup_results_dir("exact_equal_shares/cost/addone_exhaustive")
