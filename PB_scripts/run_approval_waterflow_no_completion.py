"""
Run Method of Equal Shares (waterflow) without completion (approval utilities).
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python run_approval_waterflow_no_completion.py <file_path>")
        sys.exit(1)
    ...
    results_dir = setup_results_dir("waterflow_equal_shares/approval/no_completion")
