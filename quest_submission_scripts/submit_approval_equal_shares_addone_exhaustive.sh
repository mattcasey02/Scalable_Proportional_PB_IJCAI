...
#SBATCH --job-name=approval_equal_shares_addone_exhaustive     ## Used to identify the job 
...
CUSTOM_FUNCTION_PATH="../PB_scripts/run_approval_equal_shares_addone_exhaustive.py"
