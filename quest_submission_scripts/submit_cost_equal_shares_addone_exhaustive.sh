...
#SBATCH --job-name=cost_equal_shares_addone_exhaustive     ## Used to identify the job 
...
CUSTOM_FUNCTION_PATH="../PB_scripts/run_cost_equal_shares_addone_exhaustive.py"
